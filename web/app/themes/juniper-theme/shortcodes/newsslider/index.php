...
//			}
		...
		function single_post_card(
			...
			$html .= '<div class="ls-post-card__metadata"><p class="ls-post-card__date">' . $date . ' | </p><p class="ls-post-card__category">'
			         . $category->name . '</p></div>';
